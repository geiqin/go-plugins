module github.com/geiqin/go-plugins/micro/trace/awsxray/v2
...
require (
	...
	github.com/geiqin/go-plugins/wrapper/trace/awsxray/v2 v2.0.0-20220306034312-69ff413b69f0 // indirect
